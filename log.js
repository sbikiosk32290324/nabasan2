function multiply()
	...
	var final_data= document.getElementById("note1").value;
	  ...
	  var all1=+(total1)+ +(total3)+ +(total5)+ +(total7)+ +(total9)+ +(total11)+ +(total13)+ +(total14)+ +(total15)+ +(total16)+ +(total17)+ +(total18)+ +(total19)+ +(total2)+ +(total4)+ +(total6)+ +(total8)+ +(total10)+ +(total12)+ +(total21)+ +(total22)+ +(total23)+ +(total24)+ +(total25);
