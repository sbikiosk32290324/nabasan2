...
function Search()
{
        ...
        $.getJSON("https://script.google.com/macros/s/AKfycbxa7VmaP0dN-faK-IK_xM56mIMTUSsUFLGQG4fQvMOiRoikM0YcZqU_j8hoQdNX5XWi/exec?page=search&no="+no, 
        function (data) {                                 //02
          if (data == "NOT FOUND") {                      //03
            ...
            $.each(record, function(key, value) {         //05
                  if (i == 0) {                           //06
					  ...
					  document.getElementsByName("cust_nm")[0].value = value[0];
